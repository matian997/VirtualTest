...
{
    public class StrategyScoreOpenTdb : IStrategyScore
    {
        public double GetScore(int amountCorrectAnswers, int amountQuestions, Difficulty difficulty, double timeConsumed)
        {
            double timeFactor;
